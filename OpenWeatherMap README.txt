...
The OpenWeatherMap script access the OpenWeatherAPI to give the user current weather information on a US location of the user's choosing. It was designed as part of Bellevue University's DSC 510 - Introduction to Programming.
