...
'''
This program is the final project for DSC 510, Introduction to Python. Its purpose is to access the OpenWeatherMap API
to access current weather information requested by the user. 
...
API Key to OpenWeather: 746b020611296a310f73f333c4415c0d
